 ...
 * @copyright 💖 GirlkuN 💖
 */
public class linhlua extends FutureBoss {

    public linhlua() {
        super(BossFactory.LINHLUA, BossData.LINHLUA);
    }
     ...
     int[] tempIds1 = new int[]{1571};
        ...
        if (tempId != -1) {
            ...
            if (tempId == 1571) {
             ...
             //   itemMap.options.add(new ItemOption(117, Util.nextInt(30, 50)));
