...
public class ItemOption {
  ...
  public String getOptionString() {
    // Hiển thị đặc biệt cho đục/khảm
    if (this.optionTemplate.id == 245) {
        return "|7|Số lỗ đã đục: " + this.param + "/7"; // xanh lá
    }
    if (this.optionTemplate.id == 246) {
        return "|2|Số lỗ đã khảm: " + this.param + "/7"; // xanh dương
    }

    // Các option khác giữ nguyên cơ chế cũ
