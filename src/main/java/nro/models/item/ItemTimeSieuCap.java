...
public class ItemTimeSieuCap {
    ...
    public boolean istnsm;  
    public boolean istnsm1;
    ...
    public long timetnsm;
public long timetnsm1;
    ...
    public void update() {
        if (isDuoikhi) {
         ...
         if (istnsm) {
            if (Util.canDoWithTime(timetnsm, TIME_ITEM_SC_10P)) {
                istnsm = false;
                Service.getInstance().point(player);
            }
        }
          if (istnsm1) {
            if (Util.canDoWithTime(timetnsm1, TIME_ITEM_SC_10P)) {
                istnsm1 = false;
                Service.getInstance().point(player);
            }
        }
