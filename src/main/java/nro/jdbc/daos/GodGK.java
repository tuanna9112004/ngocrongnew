    ...
    public static boolean login(Session session, AntiLogin al) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                session.tongnap1 = rs.getInt("account.tongnap");
    ...
    public static Player loadPlayer(Session session) {
        ...
        try {
            ...
            if (rss.next()) {
                ...
                session.tongnap1 = rss.getInt("account.tongnap");
        ...
        try {
            ...
            try {
                if (rs.next()) {
                    ...
                    player.phutOnline = rs.getInt("phut_online");
...
// data item time 
                    ...
                    int timeMayDo = Integer.parseInt(dataArray.get(4).toString());
                    int timeBoHuyet = Integer.parseInt(dataArray.get(5).toString());
                    int iconMeal = Integer.parseInt(dataArray.get(6).toString());
                    int timeMeal = Integer.parseInt(dataArray.get(7).toString());
                    ...
                    if (dataArray.size() > 15) {
                        timeMayDoskh = Integer.parseInt(dataArray.get(15).toString());
                    }
                    if (dataArray.size() > 16) {
                        timebinhx4 = Integer.parseInt(dataArray.get(16).toString());
                    }
                    if (dataArray.size() > 17) {
                        timetnsm = Integer.parseInt(dataArray.get(17).toString());
                    }
                    ...
                    player.itemTime.lastTimetnsm = System.currentTimeMillis() - (ItemTime.TIME_ITEM - timetnsm);
                    ...
                    player.itemTime.isUsetnsm = timetnsm != 0;
                    ...
                    dataArray = (JSONArray) jv.parse(rs.getString("level_enhance"));
                    player.levelEnhance = Integer.parseInt(dataArray.get(0).toString());
                    dataArray.clear();

                    dataArray = (JSONArray) jv.parse(rs.getString("transform_state"));
                    player.transformstate = Integer.parseInt(dataArray.get(0).toString());
                    dataArray.clear();

                    //data nangcapde
                    dataArray = (JSONArray) jv.parse(rs.getString("nangcap_detu"));
                    player.leverPet = Integer.parseInt(dataArray.get(0).toString());
                    player.LVhopthe = Integer.parseInt(dataArray.get(1).toString());
                    player.SDhopthe = Integer.parseInt(dataArray.get(2).toString());
                    player.HPhopthe = Integer.parseInt(dataArray.get(3).toString());
                    player.KIhopthe = Integer.parseInt(dataArray.get(4).toString());
                    dataArray.clear();
                    ...
                    dataArray.clear();
                    /////////////////////////
                    dataArray = (JSONArray) jv.parse(rs.getString("active_phuc_loi"));
                    for (int i = 0; i < dataArray.size(); i++) {
                    ...
                    dataArray = (JSONArray) jv.parse(rs.getString("check_online"));
                    for (int i = 0; i < dataArray.size(); i++) {
                        player.listOnline.add((int) Integer.parseInt(dataArray.get(i).toString()));
                    }
                    dataArray.clear();

                    dataArray = (JSONArray) jv.parse(rs.getString("check_diem_danh"));
                    for (int i = 0; i < dataArray.size(); i++) {
                        player.listDiemDanh.add((int) Integer.parseInt(dataArray.get(i).toString()));
                    }
                    dataArray.clear();

                    dataArray = (JSONArray) jv.parse(rs.getString("kham_ngoc"));
                    for (int i = 0; i < dataArray.size(); i++) {
                        dataObject = (JSONObject) jv.parse(String.valueOf(dataArray.get(i)));
                    ...
                    dataArray.clear();
                    player.weekTimeLogin = rs.getTimestamp("weekTimeLogin");
                    PlayerService.gI().checkNewWeek(player);

                    dataArray = (JSONArray) jv.parse(rs.getString("phong_thi_nghiem"));
                    for (int i = 0; i < dataArray.size(); i++) {
                        dataObject = (JSONObject) jv.parse(String.valueOf(dataArray.get(i)));
                    ...
                    dataArray.clear();
                    dataArray = (JSONArray) jv.parse(rs.getString("active_vong_quay"));
                    for (int i = 0; i < dataArray.size(); i++) {
