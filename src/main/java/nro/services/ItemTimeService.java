    ...
    public void sendAllItemTime(Player player) {
        ...
        if (player.itemTime.isUseCuongNo) {
          ...
          if (player.itemTime.isbinhx4) {
            sendItemTime(player, 19408, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimebinhx4)) / 1000));
        }
        ...
        if (player.itemTime.isUseMayDoskh) {
            sendItemTime(player, 6464, (int) ((TIME_MAY_DO - (System.currentTimeMillis() - player.itemTime.lastTimeUseMayDoskh)) / 1000));
        }
        ...
        if (player.itemTime.isUseBoKhi2) {
         ...
         if (player.itemTime.isUsetnsm) {
            sendItemTime(player, 19407, (int) ((TIME_ITEM - (System.currentTimeMillis()- player.itemTime.lastTimetnsm)) / 1000));
        }
        ...
        if (player.itemTimesieucap.isBienhinh) {
            sendItemTime(player, 30096, (int) ((TIME_ITEM_SC_10P - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeBienhinh)) / 1000));
        }
...
//        }
    ...
    public void sendTextRongSieuCap(Player player) {
        if (player.itemTimesieucap.isRongSieuCap) {
            ...
            sendTextTime(player, RONG_SIEU_CAP, "RỒNG THẦN ƯỚC NGUYỆN: +17%HP,KI 10% SD còn", secondsLeft);
        }
    }
