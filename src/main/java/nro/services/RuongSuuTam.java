...
public class RuongSuuTam {
    ...
    public static byte size_ruong = 20;
    public static final byte MAX_SIZE = 40;
    public static final int ID_TEMP = 457;
    public static final int QUATITY = 100;
    ...
    private void ensure(Player pl) {
        if (pl == null) return;
        if (pl.ruongSuuTam == null) pl.ruongSuuTam = new RuongSuuTamPlayer();
        if (pl.ruongSuuTam.RuongCaiTrang == null) pl.ruongSuuTam.RuongCaiTrang = new ArrayList<>();
        if (pl.ruongSuuTam.RuongPhuKien == null) pl.ruongSuuTam.RuongPhuKien = new ArrayList<>();
        if (pl.ruongSuuTam.RuongPet == null) pl.ruongSuuTam.RuongPet = new ArrayList<>();
        if (pl.ruongSuuTam.RuongLinhThu == null) pl.ruongSuuTam.RuongLinhThu = new ArrayList<>();
        if (pl.ruongSuuTam.RuongThuCuoi == null) pl.ruongSuuTam.RuongThuCuoi = new ArrayList<>();
        ensureListSize(pl.ruongSuuTam.RuongCaiTrang);
        ensureListSize(pl.ruongSuuTam.RuongPhuKien);
        ensureListSize(pl.ruongSuuTam.RuongPet);
        ensureListSize(pl.ruongSuuTam.RuongLinhThu);
        ensureListSize(pl.ruongSuuTam.RuongThuCuoi);
    }

    private void ensureListSize(List<Item> list) {
        if (list == null) return;
        for (int i = list.size(); i < size_ruong; i++) list.add(new Item());
