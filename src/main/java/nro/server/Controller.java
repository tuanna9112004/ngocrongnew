            ...
            switch (cmd) {
                ...
                case 29:
                    if (player != null && player.zone != null && player.zone.map != null) {
                        ...
                        // Log hoặc gửi thông báo cho player
                        if (player != null && player.zone == null) {
                            Service.getInstance().sendThongBao(player, "Vui lòng chờ vào map");
                            logger.warn("Player " + player.name + " zone is null when open zone UI");
                        }
                    }
                    break;
                case 21:
                    if (player != null && player.zone != null && player.zone.map != null) {
                        ...
                        if (player != null && player.zone == null) {
                            Service.getInstance().sendThongBao(player, "Vui lòng chờ vào map");
                            logger.warn("Player " + player.name + " zone is null when change zone");
                        }
                    }
                    break;
                case -71:
                ...
                case -113:
                    if (player != null) {
                        ...
                        int max = playerSkill.skillShortCut.length; // số slot tối đa
...
// Cuối hàm sendInfo(Session session)
