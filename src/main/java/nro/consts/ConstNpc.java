...
public static final String INFOR_TRAIN_OFFLINE = "Tập luyện vẫn tiếp tục và sức mạnh vẫn tăng khi Offline\n"
    ...
    public static final byte CAU_CA = 85;
     public static final byte MI_NUONG_HT = 82;
    public static final byte CUONG_HOA = 86;
...
public static final int MENU_COOKING_BEER = 10002;
public static final int FAMILY_MENU = 10003;
public static final int MARRIAGE_SELECT = 10004;
public static final int MARRIAGE_CONFIRM = 10005;
    ...
    public static final int SHOP_BA_HAT_MIT_4 = 523;
     ...
     public static final int NANG_CAP_CSHT = 1001;
    ...
    public static final int NANG_CAP_DE_TU = 1009;
        public static final int NANG_CAP_CHI_SOHT = 1010;
    public static final int MENU_BOT = 1011; // ID riêng cho menu bot
    public static final int MO_RONG_RUONG_SUU_TAM = 1012;
    public static final int NANG_CAP_KHAM_NGOC = 1013;
    public static final int DIEU_CHE = 1014;
    public static final int MO_RONG_PHONG_THI_NGHIEM = 1015;
    public static final int TANG_TOC = 1016;
    public static final int HUY_PTN = 1017;
